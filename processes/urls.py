...
urlpatterns = [
    ...
    url(r'^mixing/(?P<kneading_id>[0-9]+)/$', views.kneading_detail, name='kneading_detail'),
    url(r'^mixing/(?P<kneading_id>[0-9]+)/start_process/$', views.start_kneading, name='start_kneading'),
    url(r'^mixing/(?P<kneading_id>[0-9]+)/save_process/$', views.save_list, name='save_list'),
