...
urlpatterns = [
    ...
    url(r'^task/print_list/(?P<month>.*)$', views.print_week_plan, name = 'print_week_plan'),
    ...
    url(r'^storages/$', views.storages3, name = 'storages3'),
    ...
    url(r'^packing/(?P<pack_id>[0-9]+)/pack/$', views.pack, name='pack'),
    ...
    url(r'^archive/(?P<kneading_id>[0-9]+)/return_to_testing/$', views.return_to_testing, name='return_to_testing'),
