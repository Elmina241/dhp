...
function getLoadList(loadList, t_name) {
  ...
  for (i in loadList){
      ...
      if (t_name=='materials'){
        if (loadList[i].type != "5") $('<tr id='+ loadList[i].type + '_' + loadList[i].cont_id + '><td>' + loadList[i].mat_code + '</td><td>' + loadList[i].mat_name + '</td><td class=\"tablet\">' + "<input type='number' class='min' name=" + loadList[i].mat_code + "_min" + " style='width: 7em'" + " value=" + min + '>' + '</td><td class=\"tablet\">' + "<input type='number' class='max' name=" + loadList[i].mat_code + "_max"  + " style='width: 7em'" +  " value=" + max + '>' + "</td><td></td><td><input type='number' class='term' name=" + loadList[i].mat_code + "  min=" + min + " max=" + max + " step='0.001' value=" + loadList[i].amount + '>'+ '</td>' + '<td style="visibility:collapse;width:1px">' + loadList[i].type + '_' + loadList[i].cont_id + '_' + loadList[i].amount + '</td></tr>').appendTo(tbody);
        else {
          $('<tr id='+ loadList[i].type + '_' + loadList[i].cont_id + '><td>' + loadList[i].mat_code + '</td><td>' + loadList[i].mat_name + '</td><td class=\"tablet\">' + "<input type='number' class='min' name=" + loadList[i].mat_code + "_min"  + " style='width: 7em'" +  " value=" + min + '>' + '</td><td class=\"tablet\">' + "<input type='number' class='max' name=" + loadList[i].mat_code + "_max"  + " style='width: 7em'" +  " value=" + max + '>' + "</td><td>" + getSelectOfComp(loadList[i].cont_id)  + "</td><td><input type='number' class='term' name=" + loadList[i].mat_code + "  min=" + min + " max=" + max + " step='0.001' value=" + loadList[i].amount + '>'+ '</td>' + '<td style="visibility:collapse;width:1px">' + loadList[i].type + '_' + loadList[i].cont_id + '_' + loadList[i].amount + '</td></tr>').appendTo(tbody);
        }
      }
      else{
        $('<tr id='+ loadList[i].type + '_' + loadList[i].cont_id + '><td>' + loadList[i].mat_code + '</td><td>' + loadList[i].mat_name + '</td><td class=\"tablet\">' + min + '</td><td class="tablet">' + max + "</td><td>" + loadList[i].amount + '</td>').appendTo(tbody);
      }
  }
};
