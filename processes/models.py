...
class Model_component(models.Model):
    ...
    formula = models.ForeignKey('tables.Formula', blank=True, default = None, null=True, on_delete=models.CASCADE, verbose_name="Составной компонент")
    mat = models.ForeignKey('tables.Material', blank=True, default = None, null=True, on_delete=models.CASCADE, verbose_name="Реактив")
...
class List_component(models.Model):
    ...
    compl = models.ForeignKey('tables.Compl_comp', blank=True, default = None, null=True, on_delete=models.CASCADE, verbose_name="Существующая технологическая композиция")
    formula = models.ForeignKey('tables.Formula', blank=True, default = None, null=True, on_delete=models.CASCADE, verbose_name="Технологическая композиция собственного производства")
    r_cont = models.ForeignKey('Reactor_content', blank=True, default = None, null=True, on_delete=models.CASCADE, verbose_name="Композиция из реактора")
    t_cont = models.ForeignKey('Tank_content', blank=True, default = None, null=True, on_delete=models.CASCADE, verbose_name="Композиция из танка")
    mat = models.ForeignKey('tables.Material', blank=True, default = None, null=True, on_delete=models.CASCADE, verbose_name="Реактив")
...
class Reactor_content(models.Model):
    ...
    date = models.DateField(auto_now_add=True, verbose_name="Дата")
    batch = models.ForeignKey('Batch', blank=True, default = None, null=True, on_delete=models.CASCADE, verbose_name="Партия")
    kneading = models.ForeignKey('Kneading', blank=True, default = None, null=True, on_delete=models.CASCADE, verbose_name="Процесс смешения")
    def __str__(self):
