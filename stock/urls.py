...
urlpatterns = [
    ...
    url(r'^storages/$', views.storages2, name='storages2'),
    ...
    url(r'^shipment/del_operation/$', views.del_operation, name='del_operation'),
    ...
    url(r'^supplies/del_operation/$', views.del_operation, name='del_operation'),
    ...
    url(r'^offers/save_date/$', views.save_date, name='save_date'),
    ...
    url(r'^requirements/save_date/$', views.save_date, name='save_date'),
    url(r'^requirements/save_demand/$', views.save_demand, name='save_demand'),
    url(r'^requirements/save_changed_stock/$', views.save_changed_stock, name='save_changed_stock'),
    url(r'^offers/save_changed_stock/$', views.save_changed_stock, name='save_changed_stock'),
