...
urlpatterns = [
    ...
    url(r'^packing/$', views.packing2, name = 'packing2'),
    ...
    url(r'^stickers_table/$', views.stickers2, name = 'stickers2'),
    ...
    url(r'^stickers_table/del_sticker/$', views.del_sticker, name = 'del_sticker'),
    ...
    url(r'^stickers_table/(?P<sticker_id>[0-9]+)/$', views.sticker_detail, name='sticker_detail'),
    ...
    url(r'^characteristics/(?P<characteristic_id>[0-9]+)/save_characteristic/$', views.save_characteristic, name='save_characteristic'),
    ...
    url(r'^stickers_table/(?P<sticker_id>[0-9]+)/save_sticker/$', views.save_sticker, name='save_sticker'),
